...
active = OptimParams(
    ...
    abaqus_output_time_interval=0.1,  # Was 0.1  # TODO - make the displacement fine grained but other coarse
    abaqus_target_increment=5e-7,  # 1e-6
    time_expansion=5.0,  # Was 0.5 then 2.0, 0.2 seems OK as well
    time_released=None,
